...
<p align="center">
  <em>"One must imagine Sisyphus deploying to production"</em>
</p>

<!-- About Section -->
<p align="left">
  🌴 SoCal-based developer who believes code should make the world slightly less broken.
  <br/><br/>
  Building AI tools by day, expanding my homelab by night, and apparently quoting Camus in README files.
  I'm passionate about RAG systems, self-hosted everything, and making tech accessible to people who just want things to work.
</p>

<!-- Social Links Section -->
<p align="right">
  <a href="https://huggingface.co/gr8monk3ys" target="_blank">
    <img align="right" width="30px" style="padding-right:10px" src="https://huggingface.co/front/assets/huggingface_logo-noborder.svg" alt="HuggingFace: gr8monk3ys" />
  </a>
